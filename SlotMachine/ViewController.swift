...
//  SlotMachine
//
//  Created by Joshua Haines on 1/22/15.
...
class ViewController: UIViewController {
    ...
    func setupContainerView() {
        ...
        self.thirdContainer = UIView(frame: CGRect(x: self.view.bounds.origin.x + kMarginForView, y: self.firstContainer.frame.height + secondContainer.frame.height, width: self.view.bounds.width - (kMarginForView * 2), height: self.view.bounds.height * kSixth))
